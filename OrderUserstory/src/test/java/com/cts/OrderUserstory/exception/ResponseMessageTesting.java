package com.cts.OrderUserstory.exception;
...
import com.cts.OrderUserstory.model.ResponseMessage;
...
class ResponseMessageTest {
	...
	void testGetterSetterConstructors() {
		ResponseMessage exceptionResponse1 = new ResponseMessage(HttpStatus.NOT_FOUND,"Could not find the Order Id 127");
