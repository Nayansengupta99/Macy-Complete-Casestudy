...
import com.cognizant.repository.ProfileRepository;
...
public class ProfileService {
	...
	public ResponseEntity<List<com.cognizant.model.ProfileModel>> getAllProfile() {
		return ResponseEntity.status(HttpStatus.OK).body(profileRepo.findAll());
	}

	public ResponseEntity<com.cognizant.model.ProfileModel> saveProfile(com.cognizant.model.ProfileModel model) {
	...
	public ResponseEntity<com.cognizant.model.ProfileModel> updateProfile(com.cognizant.model.ProfileModel newModel) throws ProfileNotFoundException {
